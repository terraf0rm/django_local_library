...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        #Create a author
        test_author = Author.objects.create(first_name='John', last_name='Smith')
#        test_date = datetime.date(date_of_birth='13/02/1945', date_of_death='05/01/2018')
...
#        initial_date_of_death = datetime.date('05/01/2018')
#        self.assertEqual(resp.context['form'].initial['date_of_death'], initial_date_of_death )
    ...
    def test_redirects_to_all_authors_on_success(self):
        login = self.client.login(username='testuser2', password='12345')
